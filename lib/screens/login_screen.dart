...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget _buildBody() {
    if (_controller.currentUser.isLoggedIn == true) {
      return Column(
        mainAxisAlignment: MainAxisAlignment.spaceAround,
        children: <Widget>[
          ListTile(
            // leading: GoogleUserCircleAvatar(
            //   identity: _controller.authUser!,
            // ),
            title: Text(_controller.currentUser.name ?? ''),
            subtitle: Text(_controller.currentUser.email ?? ''),
          ),
          ElevatedButton(
            onPressed: () {
              _controller.signOut();
    ...
    return GestureDetector(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(_controller.currentUser.isLoggedIn == true
              ? "Logged In"
              : "Logged out"),
          actions: [
            IconButton(
